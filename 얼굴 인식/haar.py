...
face_cascade = cv.CascadeClassifier('./data/haaarcascades/haarcascade_frontalface_default.xml')
eye_cascade = cv.CascadeClassifier('./data/haaarcascades/haarcascade_eye.xml')


# 얼굴과 눈을 검출할 그레이스케일 이미지를 준비해놓습니다. 
img = cv.imread('tot.jpeg')
